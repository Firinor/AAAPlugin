...
Быстрый анализ: `FirUtility > Quick Analysis`  - для быстрой информации о количестве классов в проекте

Или выберите `FirUtility > Architectural Analysis Agent` - для более подробного анализа
